exports = function(payload, response) {
  ...
  .then( (cnt) => { if ( cnt === 0 ) {
    ...
    test().then(finalResult => {
      ...
      var doc={"matricola": m, "anno": a, "primo": JSON.stringify(obj[0]), "secondo": JSON.stringify(obj[1]), "terzo": JSON.stringify(obj[2]), "comp": JSON.stringify(obj[3]), "esami": JSON.stringify(obj[4]), "approvato": finalResult && f==='true', "nome": n, "cognome": c, "email": e, "fresh": f==='true', "datainvio": d, "dataapprovazione": (finalResult && f==='true') ? d : null};
